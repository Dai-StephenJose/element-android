...
Element Android is an Android Matrix Client provided by [Element](https://www.zwyktech.cn/). The app can be run on every Android devices with Android OS Lollipop and more (API 21).
